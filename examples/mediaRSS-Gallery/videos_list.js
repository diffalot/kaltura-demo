var galleryClips = [
  ...
  },
  {
    ...
    'description' : 'Ridley Scott is involved a new production called Purefold, which will be done in five separate 10-minute installments. The story is set shortly before 2019 (right ahead of the Blade Runner story). “It’s actually based on the same themes as Blade Runner,” series co-producer David Bausola told The New York Times. “It’s the search for what it means to be human and understanding the notion of empathy.” The series will be licensed with Creative Commons. \n  speaker: David Bausola — Co-Producer, Purefold '
//  },
//  {
//    'entryId' : '',
